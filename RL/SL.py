...
class Shiftable_load(Device):
    ...
    def __init__(self, simulation, id, k, T_ne, state_number, T_ini=0, T_end=23, energy_demand=0, column_info=None,
                 plots_directory="", is_active=False):
    ...
    def function(self, dict_results):
        ...
        U = (1 - self.simulation.home.p) * self.simulation.array_price[0] * E + self.simulation.home.p * (
                self.k * (((self.T_w + 24) - self.T_ini) % 24))
