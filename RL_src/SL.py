class Shiftable_load(object):
    ...
    def __init__(self, id, k, Tne, state_number, energy_demand=0, column_info=None, Tini=0, Tend=23,
        ...
        if re.match(self.working_hours, str(current_hour)):  # caso in cui posso stare nelle righe diverse da -1
            ...
            while i < loops:
                ...
                while hours_available > 0:
                    ...
                    self.Q[hour][state][bin_action] = self.Q[hour][state][bin_action] + teta * (
                ...
                i += 1
            bin_action, self.Tw, self.hours_available, self.hours_worked = self.chose_action(current_hour,
...
class SL_Battery(Shiftable_load):
    ...
    def __init__(self, id, k, max_capacity, current_state_of_charge, Tne, state_number, energy_demand=0,
...
def insert_SL_Battery(device_list, path_dir_home):
    ...
    while True:
        ...
        new_battery = SL_Battery("SL_Battery." + str(row_index), k, max_capacity, 0, 0, state_number, energy_demand,
