class Controlable_load(object):
    ...
    def __init__(self, id, beta, min_energy_demand, max_energy_demand, state_number, action_number, column_info=None,
        ...
        if re.match(self.working_hours, str(current_hour)):  # caso in cui posso stare nelle righe diverse da -1
            ...
            while i < loops:
                ...
                while index < 24 and not self.is_final_state(state):
                    ...
                    self.Q[hour][state][action] = self.Q[hour][state][action] + teta * (
                            reward + gamma * self.Q[new_hour][new_state][
...
class CL_Battery(Controlable_load):
    ...
    def __init__(self, id, beta, min_energy_demand, max_energy_demand, state_number, action_number, max_capacity,
                 current_state_of_charge=0, column_info=None, working_hours="([0-9]|1[0-9]|2[0-3])$"):
        Controlable_load.__init__(self, id, beta, min_energy_demand, max_energy_demand, state_number, action_number,
        ...
        if re.match(self.working_hours, str(current_hour)):
            ...
            while i < loops:
                ...
                while state_of_charge != self.max_capacity and index < 24:
                    ...
                    index += 1
                i += 1
            action = self.chose_action(current_hour, self.get_state(self.current_state_of_charge),
...
def insert_CL_Battery(home):
    ...
    while True:
        ...
        new_battery = CL_Battery("CL_Battery." + str(row_index), beta, min_energy_demand, max_energy_demand,
