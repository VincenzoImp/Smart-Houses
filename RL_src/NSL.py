...
class NSL_Battery(Non_shiftable_load):
    ...
    def __init__(self, id, max_capacity, current_state_of_charge=0, energy_demand=0, column_info=None,
...
def insert_NSL_Battery(device_list, path_dir_home):
    ...
    while True:
        ...
        new_NSL_Battery = NSL_Battery("NSL_Battery." + str(row_index), max_capacity, 0, energy_demand,
